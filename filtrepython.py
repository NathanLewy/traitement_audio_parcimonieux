...
P=20
b1 = scipy.signal.firwin(numtaps=2*P+1,cutoff=[0.25],window='hann',nyq=0.5)
...
P=20
b2 = scipy.signal.firwin(numtaps=2*P+1,cutoff=[0.25],window='hann',nyq=0.5,pass_zero=False)
